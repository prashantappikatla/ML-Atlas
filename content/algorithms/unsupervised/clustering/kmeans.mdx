...
compatibility:
  ...
  timeseries: false
  graph: false
tags: ["clustering", "centroid-based", "partitioning", "unsupervised", "classic"]
...
<!-- TODO: Write a one-paragraph description of K-Means -->
...
- Scales to large datasets (use MiniBatch K-Means)
...
<!-- TODO: Domain examples (customer segmentation, document clustering, etc.) -->
...
<LabEmbed url={"http://localhost:8501"} title="K-Means Clustering Lab" />
